...
<div class="wrapper">
    ...
    <div class="post-page fluid post-loop">
            ...
            <main id="content" class="" role="main">
                ...
                <article class="post">
                    ...
                    <aside class="share-post">
                        <a href="" class="share-button fb"><i class="fa fa-facebook"></i></a>
                        <a href="" class="share-button tw"><i class="fa fa-twitter"></i></a>
                        <a href="" class="share-button ps"><i class="fa fa-google-plus"></i></a>
                    </aside>
